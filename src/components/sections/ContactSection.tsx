    ...
    <section id="contact" ref={ref} className="relative py-32 md:py-40 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 sm:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            <div className="luxury-border p-8">
              ...
              {submitStatus === "success" && (
                <motion.div
                  ...
                  className="mb-6 p-4 luxury-border text-[#c9a962]"
                >
              ...
              {submitStatus === "error" && (
                <motion.div
                  initial={{ opacity: 0, y: -10 }}
                  animate={{ opacity: 1, y: 0 }}
                  className="mb-6 p-4 luxury-border text-red-400"
                >
            ...
            <div className="luxury-border p-8">
              ...
              <div className="flex gap-3">
                <motion.a
                  ...
                  className="w-12 h-12 border border-[#1f1f1c] flex items-center justify-center text-[#78716c] hover:text-[#c9a962] hover:border-[#c9a962]/50 transition-all"
                >
